(function(){var f=this;function g(a){a=a.split(".");for(var b=f,c=0;c<a.length;c++)if(b=b[a[c]],null==b)return null;return b}
...
function B(a,b){z(a);a.i=!0;for(var c=m()+(b||a.l),d=a.a[4];d.length;){var e=d.shift(),r=a.c[e];delete a.c[e];r&&w(r)}d=a.v?0:1;d=a.f>d?a.f:d;if(!(m()>=c)){do{a:{e=a;r=d;for(var t=3;t>=r;t--)for(var E=e.a[t];E.length;){var F=E.shift(),G=e.c[F];delete e.c[F];if(G){e=G;break a}}e=null}e&&w(e)}while(e&&m()<c)}a.i=!1;c=0;for(d=a.g.length;c<d;c++)e=a.g[c],a.a[e.L].push(e.id);a.l=u.a;a:{for(c=3;0<=c;c--)if(a.a[c].length){c=!0;break a}c=!1}(c||a.g.length)&&a.start();a.g.length=0}
